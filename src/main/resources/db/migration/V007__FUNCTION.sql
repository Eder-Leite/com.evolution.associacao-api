...
CREATE OR REPLACE FUNCTION FAT_FARQUIVO_FOLHA(P_DATA_PAGAMENTO DATE,
                                              P_PERIODO        NUMBER)
  RETURN NUMBER AS
BEGIN
  DBMS_SESSION.SET_CONTEXT('FAT_CARQUIVO_FOLHA',
                           'P_DATA_PAGAMENTO',
                           TO_CHAR(P_DATA_PAGAMENTO, 'DDMMYYYY'));
  RETURN P_PERIODO;
END FAT_FARQUIVO_FOLHA;
/