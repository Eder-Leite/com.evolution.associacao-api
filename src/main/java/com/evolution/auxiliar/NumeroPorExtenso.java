package com.evolution.auxiliar;
...
public class NumeroPorExtenso {
 private ArrayList<Integer> nro;
    ...
    public NumeroPorExtenso(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public NumeroPorExtenso(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
...
/*
    public static void main(String[] args) throws NumberFormatException {
        ...
        Extenso teste = new Extenso(new BigDecimal(55.69));
